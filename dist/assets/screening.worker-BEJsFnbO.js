const v0=Math.PI,E0=v0*2,C2=v0/180,t3=1440,o3=398600.8,G0=6378.135,Z0=60/Math.sqrt(G0*G0*G0/o3),T2=G0*Z0/60,U3=1/Z0,_0=.001082616,B3=-253881e-11,D3=-165597e-11,$0=B3/_0,c2=2/3,y2=1440/(2*v0);function J2(S,O){const o=[31,S%4===0?29:28,31,30,31,30,31,31,30,31,30,31],t=Math.floor(O);let B=1,D=0;for(;t>D+o[B-1]&&B<12;)D+=o[B-1],B+=1;const e=B,i=t-D;let M=(O-t)*24;const c=Math.floor(M);M=(M-c)*60;const s=Math.floor(M),U=(M-s)*60;return{mon:e,day:i,hr:c,minute:s,sec:U}}function P2(S,O,o,t,B,D,e=0){return 367*S-Math.floor(7*(S+Math.floor((O+9)/12))*.25)+Math.floor(275*O/9)+o+17210135e-1+((e/6e4+D/60+B)/60+t)/24}function G2(S,O,o,t,B,D,e=0){if(S instanceof Date){const i=S;return P2(i.getUTCFullYear(),i.getUTCMonth()+1,i.getUTCDate(),i.getUTCHours(),i.getUTCMinutes(),i.getUTCSeconds(),i.getUTCMilliseconds())}return P2(S,O,o,t,B,D,e)}function M3(S,O){const o=S-24150195e-1,t=o/365.25;let B=1900+Math.floor(t),D=Math.floor((B-1901)*.25),e=o-((B-1900)*365+D)+1e-11;e<1&&(B-=1,D=Math.floor((B-1901)*.25),e=o-((B-1900)*365+D));const i=J2(B,e),{mon:M,day:c,hr:s,minute:U}=i,E=i.sec-864e-9;return new Date(Date.UTC(B,M-1,c,s,U,Math.floor(E)))}function Q2(S,O){const{e3:o,ee2:t,peo:B,pgho:D,pho:e,pinco:i,plo:M,se2:c,se3:s,sgh2:U,sgh3:E,sgh4:d,sh2:R,sh3:m,si2:T,si3:x,sl2:N,sl3:y,sl4:G,t:a,xgh2:C,xgh3:I,xgh4:u,xh2:P,xh3:g,xi2:z,xi3:p,xl2:_,xl3:v,xl4:$,zmol:h,zmos:D0}=S,{init:W,opsmode:j}=O;let{ep:e0,inclp:n0,nodep:V,argpp:S0,mp:Q}=O,l,A,t0,w,a0,b,h0,o0,U0,K,Y,B0,L,F,X,f,H,q,O0,Z,k;const d0=119459e-10,c0=.01675,C0=.00015835218,M0=.0549;k=D0+d0*a,W==="y"&&(k=D0),Z=k+2*c0*Math.sin(k),H=Math.sin(Z),K=.5*H*H-.25,Y=-.5*H*Math.cos(Z);const R0=c*K+s*Y,g0=T*K+x*Y,n=N*K+y*Y+G*H,m0=U*K+E*Y+d*H,I0=R*K+m*Y;k=h+C0*a,W==="y"&&(k=h),Z=k+2*M0*Math.sin(k),H=Math.sin(Z),K=.5*H*H-.25,Y=-.5*H*Math.cos(Z);const P0=t*K+o*Y,z0=z*K+p*Y,N0=_*K+v*Y+$*H,i0=C*K+I*Y+u*H,X0=P*K+g*Y;return B0=R0+P0,X=g0+z0,f=n+N0,L=m0+i0,F=I0+X0,W==="n"&&(B0-=B,X-=i,f-=M,L-=D,F-=e,n0+=X,e0+=B0,w=Math.sin(n0),t0=Math.cos(n0),n0>=.2?(F/=w,L-=t0*F,S0+=L,V+=F,Q+=f):(b=Math.sin(V),a0=Math.cos(V),l=w*b,A=w*a0,h0=F*a0+X*t0*b,o0=-F*b+X*t0*a0,l+=h0,A+=o0,V%=E0,V<0&&j==="a"&&(V+=E0),q=Q+S0+t0*V,U0=f+L-X*V*w,q+=U0,O0=V,V=Math.atan2(l,A),V<0&&j==="a"&&(V+=E0),Math.abs(O0-V)>v0&&(V<O0?V+=E0:V-=E0),Q+=f,S0=q-Q-t0*V)),{ep:e0,inclp:n0,nodep:V,argpp:S0,mp:Q}}function s3(S){const{epoch:O,ep:o,argpp:t,tc:B,inclp:D,nodep:e,np:i}=S;let M,c,s,U,E,d,R,m,T,x,N,y,G,a,C,I,u,P,g,z,p,_,v,$,h,D0,W,j,e0,n0,V,S0,Q,l,A,t0,w,a0,b,h0,o0,U0,K,Y,B0,L,F,X,f,H,q,O0,Z,k,d0,c0,C0,M0,R0,g0,n,m0,I0;const P0=.01675,z0=.0549,N0=29864797e-13,i0=47968065e-14,X0=.39785416,L0=.91744867,l0=.1945905,q0=-.98088458,H0=i,r0=o,F0=Math.sin(e),Y0=Math.cos(e),T0=Math.sin(t),K0=Math.cos(t),y0=Math.sin(D),r=Math.cos(D),p0=r0*r0,f0=1-p0,Q0=Math.sqrt(f0),J=0,U2=0,S2=0,B2=0,D2=0,b0=O+18261.5+B/1440,V0=(4.523602-.00092422029*b0)%E0,A0=Math.sin(V0),W0=Math.cos(V0),O2=.91375164-.03568096*W0,t2=Math.sqrt(1-O2*O2),x0=.089683511*A0/t2,u0=Math.sqrt(1-x0*x0),s0=5.8351514+.001944368*b0;let j0=.39785416*A0/t2;const d2=u0*W0+.91744867*x0*A0;j0=Math.atan2(j0,d2),j0+=s0-V0;const I2=Math.cos(j0),A2=Math.sin(j0);z=l0,p=q0,$=L0,h=X0,_=Y0,v=F0,N=N0;const a2=1/H0;let M2=0;for(;M2<2;)M2+=1,M=z*_+p*$*v,s=-p*_+z*$*v,R=-z*v+p*$*_,m=p*h,T=p*v+z*$*_,x=z*h,c=r*R+y0*m,U=r*T+y0*x,E=-y0*R+r*m,d=-y0*T+r*x,y=M*K0+c*T0,G=s*K0+U*T0,a=-M*T0+c*K0,C=-s*T0+U*K0,I=E*T0,u=d*T0,P=E*K0,g=d*K0,n=12*y*y-3*a*a,m0=24*y*G-6*a*C,I0=12*G*G-3*C*C,O0=3*(M*M+c*c)+n*p0,Z=6*(M*s+c*U)+m0*p0,k=3*(s*s+U*U)+I0*p0,d0=-6*M*E+p0*(-24*y*P-6*a*I),c0=-6*(M*d+s*E)+p0*(-24*(G*P+y*g)+-6*(a*u+C*I)),C0=-6*s*d+p0*(-24*G*g-6*C*u),M0=6*c*E+p0*(24*y*I-6*a*P),R0=6*(U*E+c*d)+p0*(24*(G*I+y*u)-6*(C*P+a*g)),g0=6*U*d+p0*(24*G*u-6*C*g),O0=O0+O0+f0*n,Z=Z+Z+f0*m0,k=k+k+f0*I0,F=N*a2,L=-.5*F/Q0,X=F*Q0,B0=-15*r0*X,f=y*a+G*C,H=G*a+y*C,q=G*C-y*a,M2===1&&(D0=B0,W=L,j=F,e0=X,n0=f,V=H,S0=q,Q=O0,l=Z,A=k,t0=d0,w=c0,a0=C0,b=M0,h0=R0,o0=g0,U0=n,K=m0,Y=I0,z=I2,p=A2,$=O2,h=t2,_=u0*Y0+x0*F0,v=F0*u0-Y0*x0,N=i0);const s2=(4.7199672+(.2299715*b0-s0))%E0,m2=(6.2565837+.017201977*b0)%E0,p2=2*D0*V,w0=2*D0*S0,k0=2*W*w,h2=2*W*(a0-t0),r2=-2*j*l,R2=-2*j*(A-Q),f2=-2*j*(-21-9*p0)*P0,o2=2*e0*K,x2=2*e0*(Y-U0),u2=-18*e0*P0,E2=-2*W*h0,i2=-2*W*(o0-b),e2=2*B0*H,g2=2*B0*q,z2=2*L*c0,q2=2*L*(C0-d0),j2=-2*F*Z,w2=-2*F*(k-O0),k2=-2*F*(-21-9*p0)*z0,_2=2*X*m0,$2=2*X*(I0-n),n3=-18*X*z0,S3=-2*L*R0,O3=-2*L*(g0-M0);return{snodm:F0,cnodm:Y0,sinim:y0,cosim:r,sinomm:T0,cosomm:K0,day:b0,e3:g2,ee2:e2,em:r0,emsq:p0,gam:s0,peo:J,pgho:B2,pho:D2,pinco:U2,plo:S2,rtemsq:Q0,se2:p2,se3:w0,sgh2:o2,sgh3:x2,sgh4:u2,sh2:E2,sh3:i2,si2:k0,si3:h2,sl2:r2,sl3:R2,sl4:f2,s1:B0,s2:L,s3:F,s4:X,s5:f,s6:H,s7:q,ss1:D0,ss2:W,ss3:j,ss4:e0,ss5:n0,ss6:V,ss7:S0,sz1:Q,sz2:l,sz3:A,sz11:t0,sz12:w,sz13:a0,sz21:b,sz22:h0,sz23:o0,sz31:U0,sz32:K,sz33:Y,xgh2:_2,xgh3:$2,xgh4:n3,xh2:S3,xh3:O3,xi2:z2,xi3:q2,xl2:j2,xl3:w2,xl4:k2,nm:H0,z1:O0,z2:Z,z3:k,z11:d0,z12:c0,z13:C0,z21:M0,z22:R0,z23:g0,z31:n,z32:m0,z33:I0,zmol:s2,zmos:m2}}function E3(S){const{cosim:O,argpo:o,s1:t,s2:B,s3:D,s4:e,s5:i,sinim:M,ss1:c,ss2:s,ss3:U,ss4:E,ss5:d,sz1:R,sz3:m,sz11:T,sz13:x,sz21:N,sz23:y,sz31:G,sz33:a,t:C,tc:I,gsto:u,mo:P,mdot:g,no:z,nodeo:p,nodedot:_,xpidot:v,z1:$,z3:h,z11:D0,z13:W,z21:j,z23:e0,z31:n0,z33:V,ecco:S0,eccsq:Q}=S;let{emsq:l,em:A,argpm:t0,inclm:w,mm:a0,nm:b,nodem:h0,irez:o0,atime:U0,d2201:K,d2211:Y,d3210:B0,d3222:L,d4410:F,d4422:X,d5220:f,d5232:H,d5421:q,d5433:O0,dedt:Z,didt:k,dmdt:d0,dnodt:c0,domdt:C0,del1:M0,del2:R0,del3:g0,xfact:n,xlamo:m0,xli:I0,xni:P0}=S,z0,N0,i0,X0,L0,l0,q0,H0,r0,F0,Y0,T0,K0,y0,r,p0,f0,Q0,J,U2,S2,B2,D2,b0,V0,A0,W0,O2,t2,x0,u0,s0;const j0=17891679e-13,d2=21460748e-13,I2=22123015e-14,A2=17891679e-13,a2=73636953e-16,M2=21765803e-16,s2=.0043752690880113,m2=37393792e-14,p2=11428639e-14,w0=.00015835218,k0=119459e-10;o0=0,b<.0052359877&&b>.0034906585&&(o0=1),b>=.00826&&b<=.00924&&A>=.5&&(o0=2);const h2=c*k0*d,r2=s*k0*(T+x),R2=-k0*U*(R+m-14-6*l),f2=E*k0*(G+a-6);let o2=-k0*s*(N+y);(w<.052359877||w>v0-.052359877)&&(o2=0),M!==0&&(o2/=M);const x2=f2-O*o2;Z=h2+t*w0*i,k=r2+B*w0*(D0+W),d0=R2-w0*D*($+h-14-6*l);const u2=e*w0*(n0+V-6);let E2=-w0*B*(j+e0);(w<.052359877||w>v0-.052359877)&&(E2=0),C0=x2+u2,c0=o2,M!==0&&(C0-=O/M*E2,c0+=E2/M);const i2=0,e2=(u+I*s2)%E0;if(A+=Z*C,w+=k*C,t0+=C0*C,h0+=c0*C,a0+=d0*C,o0!==0){if(x0=(b/Z0)**c2,o0===2){u0=O*O;const g2=A;A=S0;const z2=l;l=Q,s0=A*l,y0=-.306-(A-.64)*.44,A<=.65?(r=3.616-13.247*A+16.29*l,f0=-19.302+117.39*A-228.419*l+156.591*s0,Q0=-18.9068+109.7927*A-214.6334*l+146.5816*s0,J=-41.122+242.694*A-471.094*l+313.953*s0,U2=-146.407+841.88*A-1629.014*l+1083.435*s0,S2=-532.114+3017.977*A-5740.032*l+3708.276*s0):(r=-72.099+331.819*A-508.738*l+266.724*s0,f0=-346.844+1582.851*A-2415.925*l+1246.113*s0,Q0=-342.585+1554.908*A-2366.899*l+1215.972*s0,J=-1052.797+4758.686*A-7193.992*l+3651.957*s0,U2=-3581.69+16178.11*A-24462.77*l+12422.52*s0,A>.715?S2=-5149.66+29936.92*A-54087.36*l+31324.56*s0:S2=1464.74-4664.75*A+3763.64*l),A<.7?(b0=-919.2277+4988.61*A-9064.77*l+5542.21*s0,B2=-822.71072+4568.6173*A-8491.4146*l+5337.524*s0,D2=-853.666+4690.25*A-8624.77*l+5341.4*s0):(b0=-37995.78+161616.52*A-229838.2*l+109377.94*s0,B2=-51752.104+218913.95*A-309468.16*l+146349.42*s0,D2=-40023.88+170470.89*A-242699.48*l+115605.82*s0),V0=M*M,z0=.75*(1+2*O+u0),N0=1.5*V0,X0=1.875*M*(1-2*O-3*u0),L0=-1.875*M*(1+2*O-3*u0),q0=35*V0*z0,H0=39.375*V0*V0,r0=9.84375*M*(V0*(1-2*O-5*u0)+.33333333*(-2+4*O+6*u0)),F0=M*(4.92187512*V0*(-2-4*O+10*u0)+6.56250012*(1+2*O-3*u0)),Y0=29.53125*M*(2-8*O+u0*(-12+8*O+10*u0)),T0=29.53125*M*(-2-8*O+u0*(12+8*O-10*u0)),O2=b*b,t2=x0*x0,W0=3*O2*t2,A0=W0*A2,K=A0*z0*y0,Y=A0*N0*r,W0*=x0,A0=W0*m2,B0=A0*X0*f0,L=A0*L0*Q0,W0*=x0,A0=2*W0*a2,F=A0*q0*J,X=A0*H0*U2,W0*=x0,A0=W0*p2,f=A0*r0*S2,H=A0*F0*D2,A0=2*W0*M2,q=A0*Y0*B2,O0=A0*T0*b0,m0=(P+p+p-(e2+e2))%E0,n=g+d0+2*(_+c0-s2)-z,A=g2,l=z2}o0===1&&(K0=1+l*(-2.5+.8125*l),f0=1+2*l,p0=1+l*(-6+6.60937*l),z0=.75*(1+O)*(1+O),i0=.9375*M*M*(1+3*O)-.75*(1+O),l0=1+O,l0=1.875*l0*l0*l0,M0=3*b*b*x0*x0,R0=2*M0*z0*K0*j0,g0=3*M0*l0*p0*I2*x0,M0=M0*i0*f0*d2*x0,m0=(P+p+o-e2)%E0,n=g+v+d0+C0+c0-(z+s2)),I0=m0,P0=z,U0=0,b=z+i2}return{em:A,argpm:t0,inclm:w,mm:a0,nm:b,nodem:h0,irez:o0,atime:U0,d2201:K,d2211:Y,d3210:B0,d3222:L,d4410:F,d4422:X,d5220:f,d5232:H,d5421:q,d5433:O0,dedt:Z,didt:k,dmdt:d0,dndt:i2,dnodt:c0,domdt:C0,del1:M0,del2:R0,del3:g0,xfact:n,xlamo:m0,xli:I0,xni:P0}}function H2(S){const O=(S-2451545)/36525;let o=-62e-7*O*O*O+.093104*O*O+(876600*3600+8640184812866e-6)*O+67310.54841;return o=o*C2/240%E0,o<0&&(o+=E0),o}function e3(S,O,o,t,B,D,e){return S instanceof Date?H2(G2(S)):H2(S)}function C3(S){const{ecco:O,epoch:o,inclo:t,opsmode:B}=S;let{no:D}=S;const e=O*O,i=1-e,M=Math.sqrt(i),c=Math.cos(t),s=c*c,U=(Z0/D)**c2,E=.75*_0*(3*s-1)/(M*i);let d=E/(U*U);const R=U*(1-d*d-d*(1/3+134*d*d/81));d=E/(R*R),D/=1+d;const m=(Z0/D)**c2,T=Math.sin(t),x=m*i,N=1-5*s,y=-N-s-s,G=1/m,a=x*x,C=m*(1-O),I="n";let u;if(B==="a"){const P=o-7305,g=Math.floor(P+1e-8),z=P-g,p=.017202791694070362,_=1.7321343856509375,v=5075514194322695e-30,$=p+E0;u=(_+p*g+$*z+P*P*v)%E0,u<0&&(u+=E0)}else u=e3(o+24332815e-1);return{no:D,method:I,ainv:G,ao:m,con41:y,con42:N,cosio:c,cosio2:s,eccsq:e,omeosq:i,posq:a,rp:C,rteosq:M,sinio:T,gsto:u}}function c3(S){const{irez:O,d2201:o,d2211:t,d3210:B,d3222:D,d4410:e,d4422:i,d5220:M,d5232:c,d5421:s,d5433:U,dedt:E,del1:d,del2:R,del3:m,didt:T,dmdt:x,dnodt:N,domdt:y,argpo:G,argpdot:a,t:C,tc:I,gsto:u,xfact:P,xlamo:g,no:z}=S;let{atime:p,em:_,argpm:v,inclm:$,xli:h,mm:D0,xni:W,nodem:j,nm:e0}=S;const n0=.13130908,V=2.8843198,S0=.37448087,Q=5.7686396,l=.95240898,A=1.8014998,t0=1.050833,w=4.4108898,a0=.0043752690880113,b=720,h0=-720,o0=259200;let U0,K,Y,B0,L,F,X,f,H=0,q=0;const O0=(u+I*a0)%E0;if(_+=E*C,$+=T*C,v+=y*C,j+=N*C,D0+=x*C,O!==0){(p===0||C*p<=0||Math.abs(C)<Math.abs(p))&&(p=0,W=z,h=g),C>0?U0=b:U0=h0;let Z=381;for(;Z===381;)O!==2?(X=d*Math.sin(h-n0)+R*Math.sin(2*(h-V))+m*Math.sin(3*(h-S0)),L=W+P,F=d*Math.cos(h-n0)+2*R*Math.cos(2*(h-V))+3*m*Math.cos(3*(h-S0)),F*=L):(f=G+a*p,Y=f+f,K=h+h,X=o*Math.sin(Y+h-Q)+t*Math.sin(h-Q)+B*Math.sin(f+h-l)+D*Math.sin(-f+h-l)+e*Math.sin(Y+K-A)+i*Math.sin(K-A)+M*Math.sin(f+h-t0)+c*Math.sin(-f+h-t0)+s*Math.sin(f+K-w)+U*Math.sin(-f+K-w),L=W+P,F=o*Math.cos(Y+h-Q)+t*Math.cos(h-Q)+B*Math.cos(f+h-l)+D*Math.cos(-f+h-l)+M*Math.cos(f+h-t0)+c*Math.cos(-f+h-t0)+2*(e*Math.cos(Y+K-A)+i*Math.cos(K-A)+s*Math.cos(f+K-w)+U*Math.cos(-f+K-w)),F*=L),Math.abs(C-p)>=b?Z=381:(q=C-p,Z=0),Z===381&&(h+=L*U0+X*o0,W+=X*U0+F*o0,p+=U0);e0=W+X*q+F*q*q*.5,B0=h+L*q+X*q*q*.5,O!==1?(D0=B0-2*j+2*O0,H=e0-z):(D0=B0-j-v+O0,H=e0-z),e0=z+H}return{atime:p,em:_,argpm:v,inclm:$,xli:h,mm:D0,xni:W,nodem:j,dndt:H,nm:e0}}var J0;(function(S){S[S.None=0]="None",S[S.MeanEccentricityOutOfRange=1]="MeanEccentricityOutOfRange",S[S.MeanMotionBelowZero=2]="MeanMotionBelowZero",S[S.PerturbedEccentricityOutOfRange=3]="PerturbedEccentricityOutOfRange",S[S.SemiLatusRectumBelowZero=4]="SemiLatusRectumBelowZero",S[S.Decayed=6]="Decayed"})(J0||(J0={}));function b2(S,O){let o,t,B,D,e,i,M,c,s,U,E,d,R,m,T,x,N,y,G,a,C,I,u,P,g,z,p;S.t=O,S.error=J0.None;const v=S.mo+S.mdot*S.t,$=S.argpo+S.argpdot*S.t,h=S.nodeo+S.nodedot*S.t;s=$,C=v;const D0=S.t*S.t;if(u=h+S.nodecf*D0,N=1-S.cc1*S.t,y=S.bstar*S.cc4*S.t,G=S.t2cof*D0,S.isimp!==1){M=S.omgcof*S.t;const r0=1+S.eta*Math.cos(v);i=S.xmcof*(r0*r0*r0-S.delmo),x=M+i,C=v+x,s=$-x,d=D0*S.t,R=d*S.t,N=N-S.d2*D0-S.d3*d-S.d4*R,y+=S.bstar*S.cc5*(Math.sin(C)-S.sinmao),G=G+S.t3cof*d+R*(S.t4cof+S.t*S.t5cof)}S.tempa=N,I=S.no;let W=S.ecco;if(a=S.inclo,S.method==="d"){m=S.t;const r0={irez:S.irez,d2201:S.d2201,d2211:S.d2211,d3210:S.d3210,d3222:S.d3222,d4410:S.d4410,d4422:S.d4422,d5220:S.d5220,d5232:S.d5232,d5421:S.d5421,d5433:S.d5433,dedt:S.dedt,del1:S.del1,del2:S.del2,del3:S.del3,didt:S.didt,dmdt:S.dmdt,dnodt:S.dnodt,domdt:S.domdt,argpo:S.argpo,argpdot:S.argpdot,t:S.t,tc:m,gsto:S.gsto,xfact:S.xfact,xlamo:S.xlamo,no:S.no,atime:S.atime,em:W,argpm:s,inclm:a,xli:S.xli,mm:C,xni:S.xni,nodem:u,nm:I};({em:W,argpm:s,inclm:a,mm:C,nodem:u,nm:I}=c3(r0))}if(I<=0)return S.error=J0.MeanMotionBelowZero,null;const j=(Z0/I)**c2*N*N;if(I=Z0/j**1.5,W-=y,W>=1||W<-.001)return S.error=J0.MeanEccentricityOutOfRange,null;W<1e-6&&(W=1e-6),C+=S.no*G,g=C+s+u,u%=E0,s%=E0,g%=E0,C=(g-s-u)%E0;const e0={am:j,em:W,im:a,Om:u,om:s,mm:C,nm:I},n0=Math.sin(a),V=Math.cos(a);let S0=W;if(P=a,U=s,p=u,z=C,D=n0,B=V,S.method==="d"){const r0={inclo:S.inclo,init:"n",ep:S0,inclp:P,nodep:p,argpp:U,mp:z,opsmode:S.operationmode},F0=Q2(S,r0);if({ep:S0,nodep:p,argpp:U,mp:z}=F0,P=F0.inclp,P<0&&(P=-P,p+=v0,U-=v0),S0<0||S0>1)return S.error=J0.PerturbedEccentricityOutOfRange,null}S.method==="d"&&(D=Math.sin(P),B=Math.cos(P),S.aycof=-.5*$0*D,Math.abs(B+1)>15e-13?S.xlcof=-.25*$0*D*(3+5*B)/(1+B):S.xlcof=-.25*$0*D*(3+5*B)/15e-13);const Q=S0*Math.cos(U);x=1/(j*(1-S0*S0));const l=S0*Math.sin(U)+x*S.aycof,t0=(z+U+p+x*S.xlcof*Q-p)%E0;c=t0,T=9999.9;let w=1;for(;Math.abs(T)>=1e-12&&w<=10;)t=Math.sin(c),o=Math.cos(c),T=1-o*Q-t*l,T=(t0-l*o+Q*t-c)/T,Math.abs(T)>=.95&&(T>0?T=.95:T=-.95),c+=T,w+=1;const a0=Q*o+l*t,b=Q*t-l*o,h0=Q*Q+l*l,o0=j*(1-h0);if(o0<0)return S.error=J0.SemiLatusRectumBelowZero,null;const U0=j*(1-a0),K=Math.sqrt(j)*b/U0,Y=Math.sqrt(o0)/U0,B0=Math.sqrt(1-h0);x=b/(1+B0);const L=j/U0*(t-l-Q*x),F=j/U0*(o-Q+l*x);E=Math.atan2(L,F);const X=(F+F)*L,f=1-2*L*L;x=1/o0;const H=.5*_0*x,q=H*x;S.method==="d"&&(e=B*B,S.con41=3*e-1,S.x1mth2=1-e,S.x7thm1=7*e-1);const O0=U0*(1-1.5*q*B0*S.con41)+.5*H*S.x1mth2*f;if(O0<1)return S.error=J0.Decayed,null;E-=.25*q*S.x7thm1*X;const Z=p+1.5*q*B*X,k=P+1.5*q*B*D*f,d0=K-I*H*S.x1mth2*X/Z0,c0=Y+I*H*(S.x1mth2*f+1.5*S.con41)/Z0,C0=Math.sin(E),M0=Math.cos(E),R0=Math.sin(Z),g0=Math.cos(Z),n=Math.sin(k),m0=Math.cos(k),I0=-R0*m0,P0=g0*m0,z0=I0*C0+g0*M0,N0=P0*C0+R0*M0,i0=n*C0,X0=I0*M0-g0*C0,L0=P0*M0-R0*C0,l0=n*M0,q0={x:O0*z0*G0,y:O0*N0*G0,z:O0*i0*G0},H0={x:(d0*z0+c0*X0)*T2,y:(d0*N0+c0*L0)*T2,z:(d0*i0+c0*l0)*T2};return{position:q0,velocity:H0,meanElements:e0}}function i3(S,O){const{opsmode:o,epoch:t,xbstar:B,xecco:D,xargpo:e,xinclo:i,xmo:M,xno:c,xnodeo:s}=O;let U,E,d,R,m,T,x,N,y,G,a,C,I,u,P,g,z,p,_,v,$,h,D0,W,j,e0,n0,V,S0,Q,l,A,t0,w,a0,b,h0,o0,U0,K,Y,B0,L,F,X,f,H,q,O0,Z,k,d0,c0,C0,M0,R0;const g0=15e-13,n=S;n.isimp=0,n.method="n",n.aycof=0,n.con41=0,n.cc1=0,n.cc4=0,n.cc5=0,n.d2=0,n.d3=0,n.d4=0,n.delmo=0,n.eta=0,n.argpdot=0,n.omgcof=0,n.sinmao=0,n.t=0,n.t2cof=0,n.t3cof=0,n.t4cof=0,n.t5cof=0,n.x1mth2=0,n.x7thm1=0,n.mdot=0,n.nodedot=0,n.xlcof=0,n.xmcof=0,n.nodecf=0,n.irez=0,n.d2201=0,n.d2211=0,n.d3210=0,n.d3222=0,n.d4410=0,n.d4422=0,n.d5220=0,n.d5232=0,n.d5421=0,n.d5433=0,n.dedt=0,n.del1=0,n.del2=0,n.del3=0,n.didt=0,n.dmdt=0,n.dnodt=0,n.domdt=0,n.e3=0,n.ee2=0,n.peo=0,n.pgho=0,n.pho=0,n.pinco=0,n.plo=0,n.se2=0,n.se3=0,n.sgh2=0,n.sgh3=0,n.sgh4=0,n.sh2=0,n.sh3=0,n.si2=0,n.si3=0,n.sl2=0,n.sl3=0,n.sl4=0,n.gsto=0,n.xfact=0,n.xgh2=0,n.xgh3=0,n.xgh4=0,n.xh2=0,n.xh3=0,n.xi2=0,n.xi3=0,n.xl2=0,n.xl3=0,n.xl4=0,n.xlamo=0,n.zmol=0,n.zmos=0,n.atime=0,n.xli=0,n.xni=0,n.bstar=B,n.ecco=D,n.argpo=e,n.inclo=i,n.mo=M,n.no=c,n.nokozai=c,n.nodeo=s,n.operationmode=o;const m0=78/G0+1,I0=42/G0,P0=I0*I0*I0*I0;n.init="y",n.t=0;const z0={ecco:n.ecco,epoch:t,inclo:n.inclo,no:n.no,method:n.method,opsmode:n.operationmode},N0=C3(z0),{ao:i0,con42:X0,cosio:L0,cosio2:l0,eccsq:q0,omeosq:H0,posq:r0,rp:F0,rteosq:Y0,sinio:T0}=N0;if(n.no=N0.no,n.con41=N0.con41,n.gsto=N0.gsto,n.a=(n.no*U3)**(-2/3),n.alta=n.a*(1+n.ecco)-1,n.altp=n.a*(1-n.ecco)-1,n.error=0,H0>=0||n.no>=0){if(n.isimp=0,F0<220/G0+1&&(n.isimp=1),n0=m0,$=P0,p=(F0-1)*G0,p<156){n0=p-78,p<98&&(n0=20);const y0=(120-n0)/G0;$=y0*y0*y0*y0,n0=n0/G0+1}_=1/r0,f=1/(i0-n0),n.eta=i0*n.ecco*f,C=n.eta*n.eta,a=n.ecco*n.eta,v=Math.abs(1-C),T=$*f**4,x=T/v**3.5,R=x*n.no*(i0*(1+1.5*C+a*(4+C))+.375*_0*f/v*n.con41*(8+3*C*(8+C))),n.cc1=n.bstar*R,m=0,n.ecco>1e-4&&(m=-2*T*f*$0*n.no*T0/n.ecco),n.x1mth2=1-l0,n.cc4=2*n.no*x*i0*H0*(n.eta*(2+.5*C)+n.ecco*(.5+2*C)-_0*f/(i0*v)*(-3*n.con41*(1-2*a+C*(1.5-.5*a))+.75*n.x1mth2*(2*C-a*(1+C))*Math.cos(2*n.argpo))),n.cc5=2*x*i0*H0*(1+2.75*(C+a)+a*C),N=l0*l0,L=1.5*_0*_*n.no,F=.5*L*_0*_,X=-.46875*D3*_*_*n.no,n.mdot=n.no+.5*L*Y0*n.con41+.0625*F*Y0*(13-78*l0+137*N),n.argpdot=-.5*L*X0+.0625*F*(7-114*l0+395*N)+X*(3-36*l0+49*N),q=-L*L0,n.nodedot=q+(.5*F*(4-19*l0)+2*X*(3-7*l0))*L0,H=n.argpdot+n.nodedot,n.omgcof=n.bstar*m*Math.cos(n.argpo),n.xmcof=0,n.ecco>1e-4&&(n.xmcof=-c2*T*n.bstar/a),n.nodecf=3.5*H0*q*n.cc1,n.t2cof=1.5*n.cc1,Math.abs(L0+1)>15e-13?n.xlcof=-.25*$0*T0*(3+5*L0)/(1+L0):n.xlcof=-.25*$0*T0*(3+5*L0)/g0,n.aycof=-.5*$0*T0;const K0=1+n.eta*Math.cos(n.mo);if(n.delmo=K0*K0*K0,n.sinmao=Math.sin(n.mo),n.x7thm1=7*l0-1,2*v0/n.no>=225){n.method="d",n.isimp=1,Y=0,P=n.inclo;const y0={epoch:t,ep:n.ecco,argpp:n.argpo,tc:Y,inclp:n.inclo,nodep:n.nodeo,np:n.no,e3:n.e3,ee2:n.ee2,peo:n.peo,pgho:n.pgho,pho:n.pho,pinco:n.pinco,plo:n.plo,se2:n.se2,se3:n.se3,sgh2:n.sgh2,sgh3:n.sgh3,sgh4:n.sgh4,sh2:n.sh2,sh3:n.sh3,si2:n.si2,si3:n.si3,sl2:n.sl2,sl3:n.sl3,sl4:n.sl4,xgh2:n.xgh2,xgh3:n.xgh3,xgh4:n.xgh4,xh2:n.xh2,xh3:n.xh3,xi2:n.xi2,xi3:n.xi3,xl2:n.xl2,xl3:n.xl3,xl4:n.xl4,zmol:n.zmol,zmos:n.zmos},r=s3(y0);n.e3=r.e3,n.ee2=r.ee2,n.peo=r.peo,n.pgho=r.pgho,n.pho=r.pho,n.pinco=r.pinco,n.plo=r.plo,n.se2=r.se2,n.se3=r.se3,n.sgh2=r.sgh2,n.sgh3=r.sgh3,n.sgh4=r.sgh4,n.sh2=r.sh2,n.sh3=r.sh3,n.si2=r.si2,n.si3=r.si3,n.sl2=r.sl2,n.sl3=r.sl3,n.sl4=r.sl4,{sinim:E,cosim:U,em:y,emsq:G,s1:h,s2:D0,s3:W,s4:j,s5:e0,ss1:V,ss2:S0,ss3:Q,ss4:l,ss5:A,sz1:t0,sz3:w,sz11:a0,sz13:b,sz21:h0,sz23:o0,sz31:U0,sz33:K}=r,n.xgh2=r.xgh2,n.xgh3=r.xgh3,n.xgh4=r.xgh4,n.xh2=r.xh2,n.xh3=r.xh3,n.xi2=r.xi2,n.xi3=r.xi3,n.xl2=r.xl2,n.xl3=r.xl3,n.xl4=r.xl4,n.zmol=r.zmol,n.zmos=r.zmos,{nm:z,z1:O0,z3:Z,z11:k,z13:d0,z21:c0,z23:C0,z31:M0,z33:R0}=r;const p0={init:n.init,ep:n.ecco,inclp:n.inclo,nodep:n.nodeo,argpp:n.argpo,mp:n.mo,opsmode:n.operationmode},f0=Q2(n,p0);n.ecco=f0.ep,n.inclo=f0.inclp,n.nodeo=f0.nodep,n.argpo=f0.argpp,n.mo=f0.mp,I=0,u=0,g=0;const Q0={cosim:U,emsq:G,argpo:n.argpo,s1:h,s2:D0,s3:W,s4:j,s5:e0,sinim:E,ss1:V,ss2:S0,ss3:Q,ss4:l,ss5:A,sz1:t0,sz3:w,sz11:a0,sz13:b,sz21:h0,sz23:o0,sz31:U0,sz33:K,t:n.t,tc:Y,gsto:n.gsto,mo:n.mo,mdot:n.mdot,no:n.no,nodeo:n.nodeo,nodedot:n.nodedot,xpidot:H,z1:O0,z3:Z,z11:k,z13:d0,z21:c0,z23:C0,z31:M0,z33:R0,ecco:n.ecco,eccsq:q0,em:y,argpm:I,inclm:P,mm:g,nm:z,nodem:u,irez:n.irez,atime:n.atime,d2201:n.d2201,d2211:n.d2211,d3210:n.d3210,d3222:n.d3222,d4410:n.d4410,d4422:n.d4422,d5220:n.d5220,d5232:n.d5232,d5421:n.d5421,d5433:n.d5433,dedt:n.dedt,didt:n.didt,dmdt:n.dmdt,dnodt:n.dnodt,domdt:n.domdt,del1:n.del1,del2:n.del2,del3:n.del3,xfact:n.xfact,xlamo:n.xlamo,xli:n.xli,xni:n.xni},J=E3(Q0);n.irez=J.irez,n.atime=J.atime,n.d2201=J.d2201,n.d2211=J.d2211,n.d3210=J.d3210,n.d3222=J.d3222,n.d4410=J.d4410,n.d4422=J.d4422,n.d5220=J.d5220,n.d5232=J.d5232,n.d5421=J.d5421,n.d5433=J.d5433,n.dedt=J.dedt,n.didt=J.didt,n.dmdt=J.dmdt,n.dnodt=J.dnodt,n.domdt=J.domdt,n.del1=J.del1,n.del2=J.del2,n.del3=J.del3,n.xfact=J.xfact,n.xlamo=J.xlamo,n.xli=J.xli,n.xni=J.xni}n.isimp!==1&&(d=n.cc1*n.cc1,n.d2=4*i0*f*d,B0=n.d2*f*n.cc1/3,n.d3=(17*i0+n0)*B0,n.d4=.5*B0*i0*f*(221*i0+31*n0)*n.cc1,n.t3cof=n.d2+2*d,n.t4cof=.25*(3*n.d3+n.cc1*(12*n.d2+10*d)),n.t5cof=.2*(3*n.d4+12*n.cc1*n.d3+6*n.d2*n.d2+15*d*(2*n.d2+d)))}b2(n,0),n.init="n"}function l3(S,O){i3(S,{opsmode:O,satn:S.satnum,epoch:S.jdsatepoch-24332815e-1,xbstar:S.bstar,xecco:S.ecco,xargpo:S.argpo,xinclo:S.inclo,xmo:S.mo,xno:S.no,xnodeo:S.nodeo})}function d3(S,O){const o="i",B=S.substring(2,7),D=parseInt(S.substring(18,20),10),e=parseFloat(S.substring(20,32));let i=parseFloat(S.substring(33,43)),M=parseFloat(`${S.substring(44,45)}.${S.substring(45,50)}E${S.substring(50,52)}`);const c=parseFloat(`${S.substring(53,54)}.${S.substring(54,59)}E${S.substring(59,61)}`),s=parseFloat(O.substring(8,16))*C2,U=parseFloat(O.substring(17,25))*C2,E=parseFloat(`.${O.substring(26,33).replace(/\s/g,"0")}`),d=parseFloat(O.substring(34,42))*C2,R=parseFloat(O.substring(43,51))*C2,m=parseFloat(O.substring(52,63))/y2;i/=y2*1440,M/=y2*1440*1440;const T=D<57?D+2e3:D+1900,x=J2(T,e),{mon:N,day:y,hr:G,minute:a,sec:C}=x,I=G2(T,N,y,G,a,C),u={error:0,satnum:B,epochyr:D,epochdays:e,ndot:i,nddot:M,bstar:c,inclo:s,nodeo:U,ecco:E,argpo:d,mo:R,no:m,jdsatepoch:I};return l3(u,o),u}const I3=S=>S.tempa<=0;function n2(S,...O){const o=O.at(-1),t=typeof o=="object"&&!(o instanceof Date)?o:void 0,B=t?O.slice(0,-1):O,e=(G2(...B)-S.jdsatepoch)*t3,i=b2(S,e);return t!=null&&t.communityDecayCheckEnabled&&i&&I3(S)?(S.error=J0.Decayed,null):i}const N2=6378.137,W2=398600.4418,A3={stations:"ISS / CSS PARTNERS","cosmos-1408-debris":"CIS (ASAT DEBRIS)","iridium-33-debris":"US (DERELICT)","cosmos-2251-debris":"CIS (DERELICT)"};function a3(S){return/\bDEB\b/.test(S)?"DEBRIS":/\bR\/B\b/.test(S)?"ROCKET BODY":"PAYLOAD"}function m3(S){return S==="DEBRIS"?"SMALL":"LARGE"}function p3(S){const O=S.slice(9,17).trim(),o=Number(O.slice(0,2));return{intl:O,launchYear:o<57?2e3+o:1900+o}}function h3(S,O){var B;const o=[];for(const{group:D,text:e}of S){const i=e.split(/\r?\n/);for(let M=0;M+2<i.length;M+=3){const c=(B=i[M])==null?void 0:B.trim(),s=i[M+1],U=i[M+2];if(!c||!(s!=null&&s.startsWith("1 "))||!(U!=null&&U.startsWith("2 ")))continue;let E;try{E=d3(s,U)}catch{continue}if(E.error!==J0.None)continue;const d=E.no/60,R=Math.cbrt(W2/(d*d)),m=E.ecco,T=a3(c),{intl:x,launchYear:N}=p3(s),y=M3(E.jdsatepoch).getTime();o.push({group:D,rec:E,object:{norad:Number(E.satnum),name:c,type:T,op:A3[D]??D.toUpperCase(),intl:x,launch:String(N),alt:Math.round(R-N2),apogee:Math.round(R*(1+m)-N2),perigee:Math.round(R*(1-m)-N2),ecc:+m.toFixed(7),incl:+(E.inclo*180/Math.PI).toFixed(4),raan:+(E.nodeo*180/Math.PI).toFixed(4),argp:+(E.argpo*180/Math.PI).toFixed(4),ma:+(E.mo*180/Math.PI).toFixed(4),period:+(2*Math.PI*Math.sqrt(R*R*R/W2)/60).toFixed(2),rcs:m3(T),age:+((O-y)/864e5).toFixed(2),tle:[s,U]}})}}const t=new Set;return o.filter(D=>t.has(D.object.norad)?!1:(t.add(D.object.norad),!0))}var r3=`ISS (ZARYA)             
...
`;const u3="2024-11-17T23:05:00Z";var g3={capturedAtUtc:u3};const Z2=Date.parse(g3.capturedAtUtc),z3=[{group:"stations",text:r3},{group:"cosmos-1408-debris",text:R3},{group:"iridium-33-debris",text:f3},{group:"cosmos-2251-debris",text:x3}],l2=h3(z3,Z2),v2=l2.map(S=>S.object);new Map(l2.map(S=>[S.object.norad,S]));v2.reduce((S,O)=>({...S,[O.type]:S[O.type]+1}),{PAYLOAD:0,"ROCKET BODY":0,DEBRIS:0});l2.reduce((S,O)=>({...S,[O.group]:(S[O.group]??0)+1}),{});v2.length;const V2={LARGE:.05,MEDIUM:.034,SMALL:.02},X2={LARGE:.05,MEDIUM:.15,SMALL:.35};function T3(S,O){return .9+.055*(S.age+O.age)+X2[S.rcs]+X2[O.rcs]}function y3(S,O,o){const t=2*o*o;return O*O/t*Math.exp(-(S*S)/t)}function F2(S,O,o){const t=n2(S,o),B=n2(O,o);if(!(t!=null&&t.position)||!t.velocity||!(B!=null&&B.position)||!B.velocity)return null;const D=t.position.x-B.position.x,e=t.position.y-B.position.y,i=t.position.z-B.position.z,M=t.velocity.x-B.velocity.x,c=t.velocity.y-B.velocity.y,s=t.velocity.z-B.velocity.z,U=Math.sqrt(D*D+e*e+i*i);return U===0?{rate:0,range:0}:{rate:(D*M+e*c+i*s)/U,range:U}}function N3(S,O,o,t=90){const B=d=>new Date(o+d*1e3);let D=-t,e=t;const i=F2(S,O,B(D)),M=F2(S,O,B(e));if(!i||!M||!(i.rate<0&&M.rate>0))return null;for(let d=0;d<24;d++){const R=(D+e)/2,m=F2(S,O,B(R));if(!m)return null;m.rate<0?D=R:e=R}const c=o+(D+e)/2*1e3,s=new Date(c),U=n2(S,s),E=n2(O,s);return!(U!=null&&U.position)||!U.velocity||!(E!=null&&E.position)||!E.velocity?null:{tca:c,missKm:Math.hypot(U.position.x-E.position.x,U.position.y-E.position.y,U.position.z-E.position.z),relvKms:Math.hypot(U.velocity.x-E.velocity.x,U.velocity.y-E.velocity.y,U.velocity.z-E.velocity.z)}}function F3(S,O,o,t,B){const D=[];for(let e=0;e<B;e++){const i=-t+e/(B-1)*t*2,M=new Date(o+i*6e4),c=n2(S,M),s=n2(O,M);!(c!=null&&c.position)||!(s!=null&&s.position)||D.push({t:i,sep:Math.hypot(c.position.x-s.position.x,c.position.y-s.position.y,c.position.z-s.position.z)})}return D}const K3=398600.4418,L2=60,K2=15*L2/2,L3=100;function G3(S){const O=S.no/60,o=Math.cbrt(K3/(O*O));return[o*(1-S.ecco),o*(1+S.ecco)]}function P3(S,{start:O,hours:o,onProgress:t}){const B=Date.now(),D=Math.round(o*3600/L2),e=S.length,i=e*(e-1)/2,M=S.map(G3),c=[],s=[];for(let I=0;I<e;I++)for(let u=I+1;u<e;u++)M[I][0]-M[u][1]>K2||M[u][0]-M[I][1]>K2||(c.push(I),s.push(u));const U=c.length,E=new Float64Array(U).fill(1/0),d=new Float64Array(U).fill(0),R=new Float64Array(U),m=new Float64Array(e),T=new Float64Array(e),x=new Float64Array(e),N=new Uint8Array(e);let y=0;const G=O.getTime();for(let I=0;I<D;I++){const u=G+I*L2*1e3,P=new Date(u);for(let g=0;g<e;g++){const z=n2(S[g],P);y++,z!=null&&z.position?(m[g]=z.position.x,T[g]=z.position.y,x[g]=z.position.z,N[g]=1):N[g]=0}for(let g=0;g<U;g++){const z=c[g],p=s[g];if(!N[z]||!N[p])continue;const _=m[z]-m[p],v=T[z]-T[p],$=x[z]-x[p],h=Math.sqrt(_*_+v*v+$*$);h<E[g]&&(E[g]=h,R[g]=u),h>d[g]&&(d[g]=h)}t&&!(I&15)&&t(I/D)}t==null||t(1);const a=[];let C=0;for(let I=0;I<U;I++)if(!(E[I]>K2)){if(d[I]<L3){C++;continue}a.push({i:c[I],j:s[I],d:E[I],t:R[I]})}return{candidates:a,cascade:{objects:e,totalPairs:i,afterRadialFilter:U,candidates:a.length,coOrbiting:C,propagations:y,steps:D,elapsedMs:Date.now()-B}}}function H3(S){return S>=.001?"CRITICAL":S>=1e-4?"HIGH":S>=1e-5?"MEDIUM":S>=1e-7?"LOW":"NOMINAL"}function W3({pc:S}){const O=(Math.log10(S)+9)/6.5;return Math.round(Math.max(.02,Math.min(.99,O))*100)}const Y2=25,V3=40,X3=121,Y3=(S,O)=>`CJ-${String(Math.min(S,O)).padStart(5,"0")}-${String(Math.max(S,O)).padStart(5,"0")}`;function J3(S,{start:O,hours:o,onProgress:t,includeSeparation:B=!0}){const D=S.map(U=>U.rec),{candidates:e,cascade:i}=P3(D,{start:O,hours:o,onProgress:U=>t==null?void 0:t(U,"screen")}),M=[];let c=0,s=0;for(let U=0;U<e.length;U++){const E=e[U],d=S[E.i].object,R=S[E.j].object,m=N3(D[E.i],D[E.j],E.t,90);if(!m){c++;continue}if(m.missKm>Y2){s++;continue}const T=Math.max(d.age,R.age),x=T3(d,R),N=V2[d.rcs]+V2[R.rcs],y=y3(m.missKm,N,x),G=+m.missKm.toFixed(3),a=+m.relvKms.toFixed(3);M.push({id:Y3(d.norad,R.norad),a:d.norad,b:R.norad,tca:m.tca,tcaMin:+((m.tca-O.getTime())/6e4).toFixed(2),miss:G,relv:a,pc:y,sev:H3(y),score:W3({pc:y}),maxAge:+T.toFixed(2),sigma:+x.toFixed(2),separation:B?F3(D[E.i],D[E.j],m.tca,V3,X3):[]}),U&63||t==null||t(U/e.length,"refine")}return t==null||t(1,"refine"),M.sort((U,E)=>U.tca-E.tca),{conjunctions:M,cascade:{...i,events:M.length,unbracketed:c,beyondGate:s,gateKm:Y2,horizonHours:o,startUtc:O.toISOString()}}}self.onmessage=S=>{const O=o=>self.postMessage(o);try{const{conjunctions:o,cascade:t}=J3(l2,{start:new Date(Z2),hours:S.data.hours,includeSeparation:!1,onProgress:(B,D)=>O({kind:"progress",stage:D,fraction:B})});O({kind:"done",conjunctions:o,cascade:t})}catch(o){O({kind:"error",message:o instanceof Error?o.message:String(o)})}};
